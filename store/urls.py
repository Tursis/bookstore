...
urlpatterns = [
    ...
    url(r'^store(\?P<product>\w+)', views.ProductListView.as_view(), name='index2',),
    # url(r'^store(?:/(?P<dummy1>[a-zA-Z]+))?(?:/(?P<dummy2>[a-zA-Z]+))?(?:/(?P<dummy3>[a-zA-Z]+))?/$',
    #     views.ProductListView.as_view(), name='index'),
