...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, help_text='Enter product category.', max_length=50, verbose_name='Категория товару')),
                ('slug', models.SlugField(max_length=100)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, help_text='Enter publisher.', max_length=50, verbose_name='Жанр')),
                ('slug', models.SlugField(max_length=100)),
            ],
        ),
        migrations.CreateModel(
